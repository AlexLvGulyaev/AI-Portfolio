...
активностью, соответствующей целевой экономической модели:
...
Оценка расходов: ~450 вызовов LLM по ~$0.001 = <$1 разово (доля
API в бюджете < 5%).
"""
...
PROFILE = {  # 600 гостей, 12 обращений = 2.0% (целевая полоса 1-3%)
