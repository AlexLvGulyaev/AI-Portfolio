    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        if "кейс" in prompt.lower() or "case" in prompt.lower():
            return "AI Portfolio включает следующие кейсы: Assistant Flow, Review Flow, Lead Qualification, HR Assistant, Prompt Review, Telegram AI Gateway, Competitor Monitor AI, HR Assistant — LoRA Fine-Tuning."
