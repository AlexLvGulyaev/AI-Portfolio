...
| 2026-09-03 | 2.4 | Актуализация на 03.09.2026: Morphic-проба реализована (Сценарий 6 — подбор кейса по описанию задачи, `POST /case-match`, до 3 кейсов с why-объяснением, флаг `MORPHIC_ENABLED`); границы сцены очищены от устаревшей пометки «не реализован»; полный UX-контур — отдельное направление (`docs/ROADMAP.md`) |
