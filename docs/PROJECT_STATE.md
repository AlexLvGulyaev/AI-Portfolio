...
Консоль планируется как отдельный React-модуль внутри проекта по маршруту `/admin/`. Детальная архитектура зафиксирована в `docs/ADMIN_CONSOLE_ARCHITECTURE.md`.

В текущую публикацию не входит реализация административной консоли.

### Технологический стек (запланированный)

| Компонент | Технология | Источник |
|-----------|-----------|----------|
| **Framework** | React 18.3 | Assistant Flow admin-ui |
| **Language** | TypeScript 5.6 | Assistant Flow admin-ui |
| **Build tool** | Vite 5.4 | Assistant Flow admin-ui |
| **Router** | react-router-dom 6.28 | Assistant Flow admin-ui |
| **Styling** | CSS | AI Portfolio design system |
